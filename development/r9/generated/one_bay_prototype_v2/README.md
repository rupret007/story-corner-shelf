# R9 printable tabletop one-bay prototype v2
...
open-bottom three-web shelf cassette.  Each support has three authored diamond
mounting bores that clear a 7.0 mm round metal-fastener envelope; do not drill
or enlarge the PETG after printing.
...
exact structural screw or rated anchor, washer, substrate, framing, long-span,
corner, and load paths remain intentionally unbound.
...
Read `ASSEMBLY.md`.  First verify all six printed mounting bores are open and
clean without reaming.  Then stand both supports on a padded
