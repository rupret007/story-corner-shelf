...
## Gate 5 — qualification-v4 review and stop
...
The final v4 result may be called **qualification-article dry-fit pass** only
...
| 4 — cable/bookend service |  |  |  | v4 review only if pass |
| 5 — qualification-v4 review |  |  |  | stop; no one-bay or wall work |
