...
and dimensions, lies on its datum without unacceptable rocking/warp, and has no
crack, split, missing feature, or pre-test whitening. This gate gives no support
strength or station-count credit.
...
## Gate 5 — qualification-v1 review and stop
...
The final v1 result may be called **qualification-article dry-fit pass** only
...
| 4 — cable/bookend service |  |  |  | v1 review only if pass |
| 5 — qualification-v1 review |  |  |  | stop; no one-bay or wall work |
