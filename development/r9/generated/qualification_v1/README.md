# R9 compact-bookend PETG qualification v1
...
2. Print `r9_compact_support`, inspect flatness, and compare it with the
   frozen R8 `r8_smooth_curved_core` control. This does not establish
...
6. The smooth outer-bookend and untrimmed corner articles are optional
   geometry controls. Do not print duplicates as a shelf set.
...
Use this bundle's `docs/` guides for records and gates.
