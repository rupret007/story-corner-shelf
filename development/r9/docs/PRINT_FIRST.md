...
For the first-shelf bill of materials and the selected—but still conditional—
GRK/washer fixture set, read
[MATERIALS_AND_HARDWARE.md](MATERIALS_AND_HARDWARE.md). For the intended Roman/
Art-Deco appearance, read [DESIGN_LANGUAGE.md](DESIGN_LANGUAGE.md). Neither
document removes the qualification and wall-install hard stops in this guide.
